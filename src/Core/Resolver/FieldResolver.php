  ...
  public function resolveFields(): array {
    ...
    foreach ($this->fields as $fieldName => $field) {
      ...
      $resolvedFields[$fieldName] = match ($fieldType) {
        'integer', 'list_integer', 'timestamp', 'created', 'changed' => new IntegerField()->getValue($field, $this->loadEntities),
        'decimal', 'list_float', 'float' => new DecimalField()->getValue($field, $this->loadEntities),
        ...
        'string', 'string_long', 'list_string', 'email', 'mail', 'uuid', 'telephone', 'datetime', 'language' => new StringField()->getValue($field, $this->loadEntities),
